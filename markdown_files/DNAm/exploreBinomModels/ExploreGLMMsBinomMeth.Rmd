...
* Read up more on the hypothesis tests and make sure we understand it. Write up the methods for the paper.
...
* Decide on alpha. This is Bayesian, so no way to correct for multiple tests
