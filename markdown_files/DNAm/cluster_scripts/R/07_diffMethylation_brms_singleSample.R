...
### Data ####
S_INPUT <- "/home/downeyam/Github/2017OAExp_Oysters/input_files/DNAm"
...
#meta_samp <- readRDS("/home/downeyam/Github/2017OAExp_Oysters/input_files/meta/metadata_20190811.RData")
meta_samp <- readRDS("/home/downeyam/Github/2017OAExp_Oysters/input_files/meta/metadata_20190811.RData")
...
loci_range <- 1:2 # Test for starting at the first locus
#target <- 1
target <- 1
...
for(target in loci_range){
  tryCatch({
    ...
    png(paste0(S_OUTPUT,"/img/CpG__",meta_locus$chr_1[target],"_",meta_locus$pos[target],"__brmsEffectsPlot.png"))
    plot(m.out2)
    dev.off()
    # Save marginal effects
    png(paste0(S_OUTPUT,"/img/CpG__",meta_locus$chr_1[target],"_",meta_locus$pos[target],"__brmsMarginalEffectsPlot.png"))
    plot(me2)
    marginal_effects()
    Sys.sleep(0.05)
    dev.off()
