...
while read line; do
        ...
        cat /shared_lab/20180226_RNAseq_2017OAExp/DNAm/rawfiles/2017_exp/${i}_*R1.fastq.gz > /shared_lab/20180226_RNAseq_2017OAExp/DNAm/rawfiles/2017_exp/${j}_DNAm_R1$
        cat /shared_lab/20180226_RNAseq_2017OAExp/DNAm/rawfiles/2017_exp/${i}_*R2.fastq.gz > /shared_lab/20180226_RNAseq_2017OAExp/DNAm/rawfiles/2017_exp/${j}_DNAm_R2$
        echo ""
        echo ""
done < $filename
