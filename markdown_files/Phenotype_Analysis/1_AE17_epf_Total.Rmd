...
text(x=-8,y=8.25,label="A",cex = 3, xpd = NA)

text(x=5,y=8,label="*",cex = 3,col=col_perm[4], xpd = NA)
text(x=51,y=8,label="*",cex = 3,col=col_perm[4], xpd = NA)
text(x=80,y=8,label="*",cex = 3,col=col_perm[4], xpd = NA)
