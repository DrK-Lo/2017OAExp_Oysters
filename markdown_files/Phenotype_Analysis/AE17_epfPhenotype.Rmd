...
ggplot(epf_wDIC_red,aes(x=timepoint,y=epf_pH,group=interaction(treatment,timepoint),colour=as.factor(treatment))) + geom_boxplot()
  
ggplot(epf_wDIC_red,aes(x=timepoint,y=DICnum,group=interaction(treatment,timepoint),colour=as.factor(treatment))) + geom_boxplot()
